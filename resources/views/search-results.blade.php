...
<div class="container mt-4">
    ...
    @if($products->isEmpty())
        <p class="text-muted">Tidak ada produk yang cocok dengan kata kunci "{{ $searchTerm }}".</p>
    @else
        <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card product-card {{ $product->status === 'available' ? '' : 'sold-out' }}" style="position: relative;">
                        ...
                        <div class="card-body">
                            ...
                            @else
                                <button class="btn btn-secondary add-to-cart-btn" disabled>Stok Habis</button>
                            @endif
                        </div>
                    </div>
                </div>
